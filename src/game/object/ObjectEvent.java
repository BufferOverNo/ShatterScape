...
public class ObjectEvent
{
		 ...
		 * @param moveToX
		 * 			The arrival destination after climbing down ladder, x co-ordinate.
		 * @param moveToY
		 * 			The arrival destination after climbing down ladder, y co-ordinate.
		 */
		 ...
		 * 			The associated player.
		 * @param moveToX
		 * 			The arrival destination after climbing up ladder, x co-ordinate.
		 * @param moveToY
		 * 			The arrival destination after climbing up ladder, y co-ordinate.
		 */
