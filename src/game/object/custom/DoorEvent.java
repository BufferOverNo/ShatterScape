...
public class DoorEvent
{
		...
		public static boolean canUseAutomaticDoor(final Player player, final int door, boolean permission, final int objectOpenId, final int objectOpenX, final int objectOpenY, int objectOpenFace, final int objectCloseFace)
		{
