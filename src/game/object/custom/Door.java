...
public class Door
{
		...
		private static void doorActionStage2(Player player, int objectId, int x, int y, int height, int face, int type, String status, int index, String objectStatus)
		{
				...
				int uniqueId = 0; // Must be 0, this has to be updated when the dynamicTileClipping is added.
				if (status.equals("Open"))
				{
						...
						if (face == 0)
						{
								...
								if (objectStatus.equals("ORIGINAL"))
								{
										...
										Region.dynamicTileClipping.add(x + " " + y + " " + height + " WEST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x - 1) + " " + y + " " + height + " EAST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x - 1) + " " + y + " " + height + " NORTH BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x - 2) + " " + y + " " + height + " NORTH-EAST BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x - 1) + " " + (y + 1) + " " + height + " SOUTH BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x - 2) + " " + (y + 1) + " " + height + " SOUTH-EAST BLOCK " + uniqueId);
								}
								else
								{
						...
						else if (face == 3)
						{
								...
								{
										uniqueId = newObjectId + newX + newY + height;
										Region.dynamicTileClipping.add((x + 0) + " " + (y - 1) + " " + height + " NORTH PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " SOUTH PASS " + uniqueId);
								}
						}
						else if (face == 2)
						{
								...
								{
										uniqueId = newObjectId + newX + newY + height;
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " EAST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 1) + " " + (y + 0) + " " + height + " WEST PASS " + uniqueId);
								}
						}
						else if (face == 1)
						{
								...
								{
										uniqueId = newObjectId + newX + newY + height;
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " NORTH PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 1) + " " + height + " SOUTH PASS " + uniqueId);
								}
								else
								{
										removePreviouslyAddedDoorClipping(objectId, x, y, height);
				...
				else if (status.equals("Close"))
				{
						...
						if (face == 1)
						{
								...
								{
										uniqueId = newObjectId + newX + newY + height;
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " EAST BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x + 1) + " " + (y + 0) + " " + height + " WEST BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " NORTH PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " NORTH-EAST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 1) + " " + height + " SOUTH-EAST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 1) + " " + height + " SOUTH PASS " + uniqueId);
										Region.dynamicTileClipping.add((x - 1) + " " + (y + 1) + " " + height + " SOUTH-EAST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x - 1) + " " + (y) + " " + height + " NORTH-EAST PASS " + uniqueId);
								}
						}
						else if (face == 0)
						{
								...
								{
										uniqueId = newObjectId + newX + newY + height;
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " NORTH BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x) + " " + (y + 1) + " " + height + " SOUTH BLOCK " + uniqueId);
								}
								else
								{
										removePreviouslyAddedDoorClipping(objectId, x, y, height);
						...
						else if (face == 3)
						{
								...
								{
										uniqueId = newObjectId + newX + newY + height;
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 0) + " " + height + " WEST BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x - 1) + " " + (y + 0) + " " + height + " EAST BLOCK " + uniqueId);
								}
								else
								{
										removePreviouslyAddedDoorClipping(objectId, x, y, height);
						...
						else if (face == 2)
						{
								...
								{
										uniqueId = newObjectId + newX + newY + height;
										Region.dynamicTileClipping.add((x + 0) + " " + (y - 1) + " " + height + " NORTH BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x) + " " + (y) + " " + height + " SOUTH BLOCK " + uniqueId);
										Region.dynamicTileClipping.add((x) + " " + (y) + " " + height + " EAST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 1) + " " + (y) + " " + height + " WEST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 0) + " " + (y + 1) + " " + height + " SOUTH-EAST PASS " + uniqueId);
										Region.dynamicTileClipping.add((x + 1) + " " + (y + 1) + " " + height + " SOUTH-WEST PASS " + uniqueId);
								}
						}
				}
		...
		{
				for (int i = 0; i < Region.dynamicTileClipping.size(); i++)
				{
						try
						{
								String[] parse = Region.dynamicTileClipping.get(i).split(" ");
								String uniqueId = parse[5];
								int currentId = objectId + x + y + height;
								if (uniqueId.equals(currentId + ""))
								{
										Region.dynamicTileClipping.remove(i);
		...
		/**
		* @return
		* 	True if it is an existing modified door.
		*/
