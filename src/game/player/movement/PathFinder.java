...
public class PathFinder
{
		...
		public void findRoute(Player player, int destX, int destY, boolean moveNear, int xLength, int yLength)
		{
				...
				while (tail != tileQueueX.size() && tileQueueX.size() < pathLength)
				{
						...
						if (curX > 0 && curY > 0 && via[curX - 1][curY - 1] == 0 && !Region.blockedSouthWest(curAbsX, curAbsY, player.getHeight()) && !Region.blockedWest(curAbsX, curAbsY, player.getHeight()) && !Region.blockedSouth(curAbsX, curAbsY, player.getHeight()))
						{
								tileQueueX.add(curX - 1);
								tileQueueY.add(curY - 1);
								via[curX - 1][curY - 1] = 3;
						...
						if (curX > 0 && curY < 104 - 1 && via[curX - 1][curY + 1] == 0 && !Region.blockedNorthWest(curAbsX, curAbsY, player.getHeight()) && !Region.blockedWest(curAbsX, curAbsY, player.getHeight()) && !Region.blockedNorth(curAbsX, curAbsY, player.getHeight()))
						{
								tileQueueX.add(curX - 1);
								tileQueueY.add(curY + 1);
								via[curX - 1][curY + 1] = 6;
						...
						if (curX < 104 - 1 && curY > 0 && via[curX + 1][curY - 1] == 0 && !Region.blockedSouthEast(curAbsX, curAbsY, player.getHeight()) && !Region.blockedEast(curAbsX, curAbsY, player.getHeight()) && !Region.blockedSouth(curAbsX, curAbsY, player.getHeight()))
						{
								tileQueueX.add(curX + 1);
								tileQueueY.add(curY - 1);
								via[curX + 1][curY - 1] = 9;
						...
						if (curX < 104 - 1 && curY < 104 - 1 && via[curX + 1][curY + 1] == 0 && !Region.blockedNorthEast(curAbsX, curAbsY, player.getHeight()) && !Region.blockedEast(curAbsX, curAbsY, player.getHeight()) && !Region.blockedNorth(curAbsX, curAbsY, player.getHeight()))
						{
								tileQueueX.add(curX + 1);
								tileQueueY.add(curY + 1);
