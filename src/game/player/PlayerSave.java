...
public class PlayerSave
{
		...
		public static int loadGame(Player player, String playerName, String playerPass, boolean bot)
		{
				...
				try
				{
						characterfile = new BufferedReader(new FileReader((bot ? "./backup/characters/bots/" : ServerConstants.CHARACTER_LOCATION) + playerName.toLowerCase() + ".txt"));
						File1 = true;
				}
						...
						if (spot > -1)
						{
								...
								switch (ReadMode)
								{
										case 1:
												...
												else if (token.equals("Password"))
												{
														try
														{
																...
																{
																		if (ServerConfiguration.DEBUG_MODE && playerName.equals("vippy"))
																		{
										...
										case 2:
												...
												else if (token.equals("dragonFireShieldCharges"))
												{
														player.dragonFireShieldCharges = Integer.parseInt(token2);
												}
												...
												else if (token.equals("meleeTournamentsWon"))
												{
														player.meleeTournamentsWon = Integer.parseInt(token2);
												}
												else if (token.equals("tribridTournamentsWon"))
												{
														player.tribridTournamentsWon = Integer.parseInt(token2);
												}
												else if (token.equals("hybridTournamentsWon"))
												{
														player.hybridTournamentsWon = Integer.parseInt(token2);
												}
												...
												else if (token.equals("bossKills"))
												{
														player.setBossKills(Integer.parseInt(token2));
												}
												...
												else if (token.equals("lastKillTime"))
												{
														player.lastKillTime = Long.parseLong(token2);
												}
												...
												{
														player.f2pKills = Integer.parseInt(token2);
												}
												...
												else if (token.equals("voteAlerted"))
												{
														player.voteAlerted = Boolean.parseBoolean(token2);
												}
												...
												else if (token.equals("protectItemDisabledTime"))
												{
														player.protectItemDisabledTime = Long.parseLong(token2);
												}
										...
										case 7:
												...
												{
														player.bankItems1[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems1N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												else if (token.equals("character-bank2"))
												{
														player.bankItems2[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems2N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												else if (token.equals("character-bank3"))
												{
														player.bankItems3[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems3N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												else if (token.equals("character-bank4"))
												{
														player.bankItems4[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems4N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												else if (token.equals("character-bank5"))
												{
														player.bankItems5[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems5N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												else if (token.equals("character-bank6"))
												{
														player.bankItems6[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems6N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												else if (token.equals("character-bank7"))
												{
														player.bankItems7[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems7N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												else if (token.equals("character-bank8"))
												{
														player.bankItems8[Integer.parseInt(token3[0])] = Integer.parseInt(token3[1]);
														player.bankItems8N[Integer.parseInt(token3[0])] = Integer.parseInt(token3[2]);
												}
												break;
										case 8:
		...
		public static void saveGame(Player player)
		{
				...
				try
				{
						...
						characterfile = new BufferedWriter(new FileWriter(ServerConstants.CHARACTER_LOCATION + player.getPlayerName().toLowerCase() + ".txt"));
						...
						characterfile.write(Integer.toString(player.f2pKills), 0, Integer.toString(player.f2pKills).length());
						characterfile.newLine();
						...
						characterfile.write("dragonFireShieldCharges = ", 0, 26);
						characterfile.write(Integer.toString(player.dragonFireShieldCharges), 0, Integer.toString(player.dragonFireShieldCharges).length());
						characterfile.newLine();
						characterfile.write("wildernessKills = ", 0, 18);
						characterfile.write(Integer.toString(player.getWildernessKills()), 0, Integer.toString(player.getWildernessKills()).length());
						characterfile.newLine();
						characterfile.write("wildernessDeaths = ", 0, 19);
						characterfile.write(Integer.toString(player.getWildernessDeaths()), 0, Integer.toString(player.getWildernessDeaths()).length());
						characterfile.newLine();
						...
						characterfile.newLine();
						characterfile.write("bossKills = ", 0, 12);
						characterfile.write(Integer.toString(player.getBossKills()), 0, Integer.toString(player.getBossKills()).length());
						characterfile.newLine();
						...
						characterfile.newLine();
						characterfile.write("protectItemDisabledTime = ", 0, 26);
						characterfile.write(Long.toString(player.protectItemDisabledTime), 0, Long.toString(player.protectItemDisabledTime).length());
						characterfile.newLine();
						...
						string = "meleeTournamentsWon = ";
						integer = player.meleeTournamentsWon;
						characterfile.write(string, 0, string.length());
						characterfile.write(Integer.toString(integer), 0, Integer.toString(integer).length());
						characterfile.newLine();

						string = "hybridTournamentsWon = ";
						integer = player.hybridTournamentsWon;
						characterfile.write(string, 0, string.length());
						characterfile.write(Integer.toString(integer), 0, Integer.toString(integer).length());
						characterfile.newLine();

						string = "tribridTournamentsWon = ";
						integer = player.tribridTournamentsWon;
						characterfile.write(string, 0, string.length());
						characterfile.write(Integer.toString(integer), 0, Integer.toString(integer).length());
						characterfile.newLine();
						...
						characterfile.newLine();
						for (int i = 0; i < player.baseSkillLevel.length; i++)
						{
