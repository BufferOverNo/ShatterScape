...
public class ZombieGameInstance
{
		 ...
		 */
		public ZombieGameInstance(String playerOneName, String playerTwoName, int wave, String chestCoordinates, String zombieList, int chestId, int height, int totalWaveZombiesLeft, String zombieSpawns, boolean playerOneAvailable, boolean playerTwoAvailable)
		{
