...
public class ZombieWaveInstance
{
		 ...
		 * Zombie wave data.
		 */
		public ZombieWaveInstance(int wave, String teleportCoordinates, String chestCoordinates, String shopList, int chestId, int totalZombies, String zombieSpawns, int points, int bossId, String bossDrops, String anvilCoordinates, String teleportCoordinatesSaved)
		{
				this.wave = wave;
		...
		private static void loadWaveData()
		{
				...
				try
				{
						BufferedReader file = new BufferedReader(new FileReader("./data/content/zombie/wave.txt"));
						String line;
						while ((line = file.readLine()) != null)
						{
								...
								if (line.contains("Wave level:"))
								{
										...
										if (wave - waveBefore > 0)
										{
												...
												for (int index = 0; index < wave - waveBefore; index++)
												{
														...
														ZombieWaveInstance data = new ZombieWaveInstance(waveToAdd, teleportCoordinates, chestCoordinates, shopList, chestId, totalZombies, zombieCoords, points, bossId, bossDrops, anvilCoordinates, teleportCoordinatesSaved);
														instance.add(data);
														bossId = 0;
														bossDrops = "";
														teleportCoordinates = "";
								...
								else if (line.isEmpty())
								{
										...
										ZombieWaveInstance data = new ZombieWaveInstance(wave, teleportCoordinates, chestCoordinates, shopList, chestId, totalZombies, zombieCoords, points, bossId, bossDrops, anvilCoordinates, teleportCoordinatesSaved);
										instance.add(data);
										bossId = 0;
										bossDrops = "";
										teleportCoordinates = "";
		...
		*/
		...
		private static void loadItemDrops()
		{
				...
				try
				{
						BufferedReader file = new BufferedReader(new FileReader("./data/content/zombie/wave drops.txt"));
						String line;
						while ((line = file.readLine()) != null)
						{
