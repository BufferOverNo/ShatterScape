...
public class CombatConstants
{
		 ...
		 */
		public final static int[] REDUCE_SPELL_TIME = {250000, 250000, 250000, 500000, 500000, 500000};

		/**
		 * Reduce spell identities.
		 */
		public final static int[] REDUCE_SPELLS = {1153, 1157, 1161, 1542, 1543, 1562};
		 ...
		 * @param itemId
		 * @return
		 * 		True if the itemId given is a Dark bow.
		 */
		public static boolean isDarkBow(int itemId)
		{
				int[] darkBows = {11235, 15701, 15702, 15703, 15704};
		...
		public final static int[][] MAGIC_SPELLS = {
				...
				{12445, 85, 1819, 1841, 1842, 1843, 0, 80, 563, 1, 562, 1, 560, 1, 0, 0
						// Teleblock.
						},
				...
				{-1, 21, 712, 112, 0, 0, 0, 31, 554, 3, 561, 1, 0, 0, 0, 0
						// Low alch.
						},
				{-1, 55, 713, 113, 0, 0, 0, 65, 554, 5, 561, 1, 0, 0, 0, 0
						// High alch.
						},
				// Telegrab.
				{-1, 33, 728, 142, 143, 144, 0, 35, 556, 1, 563, 1, 0, 0, 0, 0},
				// Trident of the swamp
				{-1, 75, 1167, -1, 2624, 2625, 32, 35, 0, 0, 0, 0, 0, 0, 0, 0},};
