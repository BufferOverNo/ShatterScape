...
public class PureTribrid
{
		...
		public static int[][] getEquipment()
		{
				...
				int[][] equipment = {{Pure.robeAndHatSet[randomOutFitSet][0], 1}, {QuickSetUp.getRandomGodCape(), 1}, {1712, 1}, {4675, 1}, {6107, 1}, {3842, 1}, {-1, 1}, {6108, 1}, {-1, 1}, {7459, 1}, {3105, 1}, {-1, 1}, {-1, 1}, {9244, 15}};
				return equipment;
		}
}