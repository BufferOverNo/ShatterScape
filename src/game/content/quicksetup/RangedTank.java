...
public class RangedTank
{
		...
		// @formatter:off.
			int[][] equipment =
			{
				...
				{
					weaponSet[randomWeaponSet][2], !bot.isBot ? 25 : ammoAmount // Arrow.
				}
			};
			// @formatter:on.
				return equipment;
		...
		public static int[][] inventory(Player bot)
		{
				...
				if (bot.botPrimaryWeapon == 15241)
				{
						...
						ItemAssistant.replaceEquipmentSlot(bot, ServerConstants.ARROW_SLOT, bot.botArrowPrimary, 40, false, false);
				}
