...
public class MeleeMain
{
		...
		{
			11694, 50 // Armadyl Godsword.
		},
		{
			14484, 50 // Dragon claws.
		},
		{
			18771, 50 // Dragon warhammer.
		}
		};
		...
		public static int[][] inventory(Player bot)
		{
				...
				int defender = berserker ? 8850 : 18759;
				int primaryWeapon = -1;
				int shieldItem = -1;
				...
				else
				{
						...
						if (primaryWeapon == 11694) // Armadyl godsword.
						{
				...
				ItemAssistant.replaceEquipmentSlot(bot, ServerConstants.WEAPON_SLOT, primaryWeapon, 1, false, false);
				if (shieldItem > 0)
				{
						ItemAssistant.replaceEquipmentSlot(bot, ServerConstants.SHIELD_SLOT, shieldItem, 1, false, false);
				}
