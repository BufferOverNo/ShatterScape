...
public class Pure
{
		...
		{
				int randomOutFitSet = Misc.random(robeAndHatSet.length - 1);
				...
				*/
				...
				int bodySlotItem = robeAndHatSet[randomOutFitSet][1];

				int legSlotItem = primaryRanged ? 2497 : robeAndHatSet[randomOutFitSet][2];
				...
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.CAPE_SLOT, primaryRanged ? 10499 : QuickSetUp.getTeamCape(false), 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.HEAD_SLOT, robeAndHatSet[randomOutFitSet][0], 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.BODY_SLOT, result[0], 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.LEG_SLOT, result[1], 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.WEAPON_SLOT, weaponSet[randomWeaponSet][0], 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.SHIELD_SLOT, weaponSet[randomWeaponSet][1], 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.ARROW_SLOT, weaponSet[randomWeaponSet][2], ammoAmount, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.AMULET_SLOT, weaponSet[randomWeaponSet][3], 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.HAND_SLOT, 7459, 1, false, false);
				ItemAssistant.replaceEquipmentSlot(player, ServerConstants.FEET_SLOT, 3105, 1, false, false);
		...
		{
			{
				initiate ? 5574 : robeAndHatSet[randomOutFitSet][0], 1 // Head.
			},
			{
			...
			{
				initiate ? 5575 : robeAndHatSet[randomOutFitSet][1], 1 // Body.
			},
			{
			...
			{
				initiate ? 5576 : (primaryRanged ? 2497 : robeAndHatSet[randomOutFitSet][2]), 1  // Leg.
			},
			{
				-1, 1 // Empty.
			},
