...
public class QuickPrayers
{
		...
		private static final int[] defPrayId = {67050, 67055, 67063, 67075, 89182};

		private static final int[] strPrayId = {67051, 67056, 67064, 67075, 89182};

		private static final int[] atkPrayId = {67052, 67057, 67065, 67075, 89182};

		private static final int[] rangePrayId = {67053, 67061, 67069, 89183};

		private static final int[] magePrayId = {67054, 67062, 67070, 89184};

		private static final int[] headIconsId = {67066, 67067, 67068, 67071, 67072, 67073};

		private static final int[] defPray = {0, 5, 13, ServerConstants.CHIVALRY, 25};

		private static final int[] strPray = {1, 6, 14, ServerConstants.CHIVALRY, 25};

		private static final int[] atkPray = {2, 7, 15, ServerConstants.CHIVALRY, 25};

		private static final int[] rangePray = {3, 11, 19, ServerConstants.RIGOUR};

		private static final int[] magePray = {4, 12, 20, ServerConstants.AUGURY};
		...
		private static final int[][] data = {
				...
				{89184, 679, ServerConstants.AUGURY}}; // Augury
		...
		{
				player.playerAssistant.setSidebarInterface(5, 5608);
		}
		...
		public static void turnOffQuicks(Player player)
		{
				...
				for (int i = 0; i < player.quickPrayers.length; i++)
				{
						...
						{
								PrayerBook.activatePrayer(player, i);
