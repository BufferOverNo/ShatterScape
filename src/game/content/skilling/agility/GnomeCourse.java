						...
						case 23559:
								...
								CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
								{
										...
										public void stop()
										{
												...
												Skilling.addSkillExperience(player, 5, ServerConstants.AGILITY);
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void stop()
						{
								...
								if (player.logBalance && player.obstacleNetUp && player.treeBranchUp && player.balanceRope && player.treeBranchDown && player.obstacleNetOver)
								{
										...
										String s = amount == 1 ? "" : "s";
										player.playerAssistant.sendFilterableMessage("The gnomes award you " + amount + " agility point" + s + " for your efforts.");
