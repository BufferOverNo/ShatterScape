		...
		private static void obstaclePipe(final Player player)
		{
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void stop()
						{
								...
								Skilling.addSkillExperience(player, 10, ServerConstants.AGILITY);
						}
				}, 1);
		...
		private static void ropeSwingAction(final Player player)
		{
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void stop()
						{
								...
								player.setDoingAgility(false);
								AgilityAssistant.resetAgilityWalk(player);
								Skilling.addSkillExperience(player, 22, ServerConstants.AGILITY);
						}
				}, 1);
		}
						...
						case OBSTACLE_NET:
								...
								CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
								{
										...
										public void stop()
										{
												...
												Skilling.addSkillExperience(player, 8, ServerConstants.AGILITY);
										}
								}, 1);
										...
										CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
										{
												...
												public void stop()
												{
														...
														if (player.ropeSwing && player.logBalance1 && player.obstacleNet && player.balancingLedge && player.Ladder)
														{
																...
																String s = amount == 1 ? "" : "s";
																player.playerAssistant.sendFilterableMessage("The barbarians award you " + amount + " agility point" + s + " for your efforts.");
																Skilling.addSkillExperience(player, 200, ServerConstants.AGILITY);
																Achievements.checkCompletionSingle(player, 1029);
														}
														else
														{
																Skilling.addSkillExperience(player, 14, ServerConstants.AGILITY);
														}
												}
										}, 1);
								}
