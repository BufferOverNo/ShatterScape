...
public class Smithing
{
		...
		public static final int[] ORES_SMELT = {436, 438, 440, 442, 447, 449, 451};

		public static final String[] ORES_SMELT_NAME = {"BRONZE", "BRONZE", "IRON", "STEEL", "MITHRIL", "ADAMANT", "RUNE"};
								...
								public void execute(CycleEventContainer container)
								{
										...
										if (ItemAssistant.hasItemAmountInInventory(player, 436, 1))
										{
												if (ItemAssistant.hasItemAmountInInventory(player, 438, 1))
												{
														...
														Skilling.addSkillExperience(player, 26, ServerConstants.SMITHING);
														if (!superheatType.isEmpty())
														{
																...
																Skilling.addSkillExperience(player, 53, ServerConstants.MAGIC);
						...
						CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
						{
								...
								public void execute(CycleEventContainer container)
								{
										...
										if (ItemAssistant.hasItemAmountInInventory(player, 440, 1))
										{
												...
												Skilling.addSkillExperience(player, 13, ServerConstants.SMITHING);
								...
								public void execute(CycleEventContainer container)
								{
										...
										if (ItemAssistant.hasItemAmountInInventory(player, 440, 1))
										{
												if (ItemAssistant.hasItemAmountInInventory(player, 453, 1))
												{
														...
														Skilling.addSkillExperience(player, 18, ServerConstants.SMITHING);
						...
						CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
						{
								...
								public void execute(CycleEventContainer container)
								{
										...
										if (ItemAssistant.hasItemAmountInInventory(player, 444, 1))
										{
												...
												Skilling.addSkillExperience(player, 23, ServerConstants.SMITHING);
								...
								public void execute(CycleEventContainer container)
								{
										...
										if (ItemAssistant.hasItemAmountInInventory(player, 453, 2))
										{
												if (ItemAssistant.hasItemAmountInInventory(player, 447, 1))
												{
														...
														Skilling.addSkillExperience(player, 30, ServerConstants.SMITHING);
								...
								public void execute(CycleEventContainer container)
								{
										...
										if (ItemAssistant.hasItemAmountInInventory(player, 453, 3))
										{
												if (ItemAssistant.hasItemAmountInInventory(player, 449, 1))
												{
														...
														Skilling.addSkillExperience(player, 38, ServerConstants.SMITHING);
								...
								public void execute(CycleEventContainer container)
								{
										...
										if (ItemAssistant.hasItemAmountInInventory(player, 453, 4))
										{
												if (ItemAssistant.hasItemAmountInInventory(player, 451, 1))
												{
														...
														Skilling.addSkillExperience(player, 50, ServerConstants.SMITHING);
		...
		public static boolean doaction(final Player player, final int toProduce, final int toremove, final int toRemoveAmount, int timestomake, int NOTUSED, int NOTUSED2, final int xp)
		{

				if (Skilling.canActivateNewSkillingEvent(player, "SMITHING ITEMS"))
				{
						return false;
				}
				...
				if (ItemAssistant.hasItemAmountInInventory(player, toremove, toRemoveAmount))
				{
						...
						{
								player.playerAssistant.sendFilterableMessage("You hammer the " + ItemAssistant.getItemName(toremove) + " and make some " + ItemAssistant.getItemName(toProduce) + ".");
						}
						else
						{
								String text = ItemDefinition.getDefinitions()[toProduce].stackable ? "some" : "a";
								player.playerAssistant.sendFilterableMessage("You hammer the " + ItemAssistant.getItemName(toremove) + " and make " + text + " " + ItemAssistant.getItemName(toProduce) + ".");
						}
						CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
						{
								@Override
								public void execute(CycleEventContainer container)
								{
										...
										if (!Skilling.isSkillingEventActive(player, "SMITHING ITEMS"))
										{
												container.stop();
												return;
										}
										...
										if (ItemAssistant.hasItemAmountInInventory(player, toremove, toRemoveAmount))
										{
												...
												Skilling.addSkillExperience(player, xp, ServerConstants.SMITHING);
												int bloodMoney = (int) (0.42 * xp);
												if (bloodMoney > 0)
												{
														ItemAssistant.addItemToInventoryOrDrop(player, 18644, bloodMoney);
														CoinEconomyTracker.incomeList.add("SKILLING " + bloodMoney);
												}
