...
public class SmithingInterface
{
		...
		private static void makeRuneInterface(Player player)
		{
				...
				player.getPA().sendFrame126(GetForlvl(90, player) + "Arrowtips" + GetForlvl(5, player), 1108);
				...
				player.getPA().sendFrame34(1213, 0, 1119, 1); //dagger
				player.getPA().sendFrame34(1359, 0, 1120, 1); //axe
				player.getPA().sendFrame34(1113, 0, 1121, 1); //chain body
				player.getPA().sendFrame34(1147, 0, 1122, 1); //med helm
				player.getPA().sendFrame34(9381, 0, 1123, 10); //Bolts

				player.getPA().sendFrame34(1289, 1, 1119, 1); //s-sword
				player.getPA().sendFrame34(1432, 1, 1120, 1); //mace
				player.getPA().sendFrame34(1079, 1, 1121, 1); //platelegs
				player.getPA().sendFrame34(1163, 1, 1122, 1); //full helm
				player.getPA().sendFrame34(44, 1, 1123, 15); //arrowtips

				player.getPA().sendFrame34(1333, 2, 1119, 1); //scimmy
				player.getPA().sendFrame34(1347, 2, 1120, 1); //warhammer
				player.getPA().sendFrame34(1093, 2, 1121, 1); //plateskirt
				player.getPA().sendFrame34(1185, 2, 1122, 1); //Sq. Shield
				player.getPA().sendFrame34(868, 2, 1123, 5); //throwing-knives

				player.getPA().sendFrame34(1303, 3, 1119, 1); //longsword
				player.getPA().sendFrame34(1373, 3, 1120, 1); //battleaxe
				player.getPA().sendFrame34(1127, 3, 1121, 1); //platebody
				player.getPA().sendFrame34(1201, 3, 1122, 1); //kiteshield
				player.getPA().sendFrame34(9431, 3, 1123, 1); // Runite limbs.

				player.getPA().sendFrame34(1319, 4, 1119, 1); //2h sword

				player.getPA().sendFrame34(-1, 4, 1120, 1);
				player.getPA().sendFrame34(-1, 4, 1121, 1);
				player.getPA().sendFrame34(-1, 4, 1123, 1);
				player.getPA().sendFrame126(" ", 8428);

				player.getPA().sendFrame34(4824, 4, 1122, 15); //nails
		...
		private static void makeAddyInterface(Player player)
		{
				...
				player.getPA().sendFrame126(GetForlvl(75, player) + "Arrowtips" + GetForlvl(5, player), 1108);
				...
				player.getPA().sendFrame34(1211, 0, 1119, 1); //dagger
				player.getPA().sendFrame34(1357, 0, 1120, 1); //axe
				player.getPA().sendFrame34(1111, 0, 1121, 1); //chain body
				player.getPA().sendFrame34(1145, 0, 1122, 1); //med helm
				player.getPA().sendFrame34(9380, 0, 1123, 10); //Bolts
				player.getPA().sendFrame34(1287, 1, 1119, 1); //s-sword
				player.getPA().sendFrame34(1430, 1, 1120, 1); //mace
				player.getPA().sendFrame34(1073, 1, 1121, 1); //platelegs
				player.getPA().sendFrame34(1161, 1, 1122, 1); //full helm
				player.getPA().sendFrame34(43, 1, 1123, 15); //arrowtips
				player.getPA().sendFrame34(1331, 2, 1119, 1); //scimmy
				player.getPA().sendFrame34(1345, 2, 1120, 1); //warhammer
				player.getPA().sendFrame34(1091, 2, 1121, 1); //plateskirt
				player.getPA().sendFrame34(1183, 2, 1122, 1); //Sq. Shield
				player.getPA().sendFrame34(867, 2, 1123, 5); //throwing-knives
				player.getPA().sendFrame34(1301, 3, 1119, 1); //longsword
				player.getPA().sendFrame34(1371, 3, 1120, 1); //battleaxe
				player.getPA().sendFrame34(1123, 3, 1121, 1); //platebody
				player.getPA().sendFrame34(1199, 3, 1122, 1); //kiteshield
				player.getPA().sendFrame34(1317, 4, 1119, 1); //2h sword
				player.getPA().sendFrame34(4823, 4, 1122, 15); //nails
				player.getPA().sendFrame34(-1, 3, 1123, 1);
				player.getPA().sendFrame126(" ", 1135);
				player.getPA().sendFrame126(" ", 1134);
				player.getPA().sendFrame126(" ", 11461);
				player.getPA().sendFrame126(" ", 11459);
		...
		private static void makeMithInterface(Player player)
		{
				...
				player.getPA().sendFrame126(GetForlvl(55, player) + "Arrowtips" + GetForlvl(5, player), 1108);
				...
				player.getPA().sendFrame34(1209, 0, 1119, 1); //dagger
				player.getPA().sendFrame34(1355, 0, 1120, 1); //axe
				player.getPA().sendFrame34(1109, 0, 1121, 1); //chain body
				player.getPA().sendFrame34(1143, 0, 1122, 1); //med helm
				player.getPA().sendFrame34(9379, 0, 1123, 10); //Bolts
				player.getPA().sendFrame34(1285, 1, 1119, 1); //s-sword
				player.getPA().sendFrame34(1428, 1, 1120, 1); //mace
				player.getPA().sendFrame34(1071, 1, 1121, 1); //platelegs
				player.getPA().sendFrame34(1159, 1, 1122, 1); //full helm
				player.getPA().sendFrame34(42, 1, 1123, 15); //arrowtips
				player.getPA().sendFrame34(1329, 2, 1119, 1); //scimmy
				player.getPA().sendFrame34(1343, 2, 1120, 1); //warhammer
				player.getPA().sendFrame34(1085, 2, 1121, 1); //plateskirt
				player.getPA().sendFrame34(1181, 2, 1122, 1); //Sq. Shield
				player.getPA().sendFrame34(866, 2, 1123, 5); //throwing-knives
				player.getPA().sendFrame34(1299, 3, 1119, 1); //longsword
				player.getPA().sendFrame34(1369, 3, 1120, 1); //battleaxe
				player.getPA().sendFrame34(1121, 3, 1121, 1); //platebody
				player.getPA().sendFrame34(1197, 3, 1122, 1); //kiteshield
				player.getPA().sendFrame34(1315, 4, 1119, 1); //2h sword
				player.getPA().sendFrame34(4822, 4, 1122, 15); //nails
				player.getPA().sendFrame34(-1, 3, 1123, 1);
				player.getPA().sendFrame126(" ", 1135);
				player.getPA().sendFrame126(" ", 1134);
				player.getPA().sendFrame126(" ", 11461);
		...
		private static void makeSteelInterface(Player player)
		{
				...
				player.getPA().sendFrame126(GetForlvl(35, player) + "Arrowtips" + GetForlvl(5, player), 1108);
				...
				player.getPA().sendFrame126(" ", 1096);
				player.getPA().sendFrame126(" ", 1134);
				player.getPA().sendFrame34(1207, 0, 1119, 1);
				player.getPA().sendFrame34(1353, 0, 1120, 1);
				player.getPA().sendFrame34(1105, 0, 1121, 1);
				player.getPA().sendFrame34(1141, 0, 1122, 1);
				player.getPA().sendFrame34(9378, 0, 1123, 10);
				player.getPA().sendFrame34(1281, 1, 1119, 1);
				player.getPA().sendFrame34(1424, 1, 1120, 1);
				player.getPA().sendFrame34(1069, 1, 1121, 1);
				player.getPA().sendFrame34(1157, 1, 1122, 1);
				player.getPA().sendFrame34(41, 1, 1123, 15);
				player.getPA().sendFrame34(1325, 2, 1119, 1);
				player.getPA().sendFrame34(1339, 2, 1120, 1);
				player.getPA().sendFrame34(1083, 2, 1121, 1);
				player.getPA().sendFrame34(1177, 2, 1122, 1);
				player.getPA().sendFrame34(865, 2, 1123, 5);
				player.getPA().sendFrame34(1295, 3, 1119, 1);
				player.getPA().sendFrame34(1365, 3, 1120, 1);
				player.getPA().sendFrame34(1119, 3, 1121, 1);
				player.getPA().sendFrame34(1193, 3, 1122, 1);
				player.getPA().sendFrame34(1311, 4, 1119, 1);
				player.getPA().sendFrame34(1539, 4, 1122, 15);
				player.getPA().sendFrame34(-1, 3, 1123, 4);
				player.getPA().sendFrame34(-1, 4, 1123, 1);
		...
		private static void makeIronInterface(Player player)
		{
				...
				player.getPA().sendFrame126(GetForlvl(20, player) + "Arrowtips" + GetForlvl(5, player), 1108);
				...
				player.getPA().sendFrame34(1203, 0, 1119, 1);
				player.getPA().sendFrame34(1349, 0, 1120, 1);
				player.getPA().sendFrame34(1101, 0, 1121, 1);
				player.getPA().sendFrame34(1137, 0, 1122, 1);
				player.getPA().sendFrame34(9377, 0, 1123, 10);
				player.getPA().sendFrame34(1279, 1, 1119, 1);
				player.getPA().sendFrame34(1420, 1, 1120, 1);
				player.getPA().sendFrame34(1067, 1, 1121, 1);
				player.getPA().sendFrame34(1153, 1, 1122, 1);
				player.getPA().sendFrame34(40, 1, 1123, 15);
				player.getPA().sendFrame34(1323, 2, 1119, 1);
				player.getPA().sendFrame34(1335, 2, 1120, 1);
				player.getPA().sendFrame34(1081, 2, 1121, 1);
				player.getPA().sendFrame34(1175, 2, 1122, 1);
				player.getPA().sendFrame34(863, 2, 1123, 5);
				player.getPA().sendFrame34(1293, 3, 1119, 1);
				player.getPA().sendFrame34(1363, 3, 1120, 1);
				player.getPA().sendFrame34(1115, 3, 1121, 1);
				player.getPA().sendFrame34(1191, 3, 1122, 1);
				player.getPA().sendFrame34(1309, 4, 1119, 1);
				player.getPA().sendFrame34(4820, 4, 1122, 15);
				player.getPA().sendFrame34(4540, 4, 1121, 1);
				player.getPA().sendFrame34(-1, 3, 1123, 1);
				player.getPA().sendFrame34(-1, 4, 1120, 1);
				player.getPA().sendFrame34(-1, 4, 1121, 1);
				player.getPA().sendFrame34(-1, 4, 1123, 1);
		...
		private static void makeBronzeInterface(Player player)
		{
				...
				player.getPA().sendFrame126(GetForlvl(5, player) + "Arrowtips" + GetForlvl(5, player), 1108);
				...
				player.getPA().sendFrame34(1205, 0, 1119, 1);
				player.getPA().sendFrame34(1351, 0, 1120, 1);
				player.getPA().sendFrame34(1103, 0, 1121, 1);
				player.getPA().sendFrame34(1139, 0, 1122, 1);
				player.getPA().sendFrame34(9375, 0, 1123, 10);
				player.getPA().sendFrame34(1277, 1, 1119, 1);
				player.getPA().sendFrame34(1422, 1, 1120, 1);
				player.getPA().sendFrame34(1075, 1, 1121, 1);
				player.getPA().sendFrame34(1155, 1, 1122, 1);
				player.getPA().sendFrame34(39, 1, 1123, 15);
				player.getPA().sendFrame34(1321, 2, 1119, 1);
				player.getPA().sendFrame34(1337, 2, 1120, 1);
				player.getPA().sendFrame34(1087, 2, 1121, 1);
				player.getPA().sendFrame34(1173, 2, 1122, 1);
				player.getPA().sendFrame34(864, 2, 1123, 5);
				player.getPA().sendFrame34(1291, 3, 1119, 1);
				player.getPA().sendFrame34(1375, 3, 1120, 1);
				player.getPA().sendFrame34(1117, 3, 1121, 1);
				player.getPA().sendFrame34(1189, 3, 1122, 1);
				player.getPA().sendFrame34(1307, 4, 1119, 1);
				player.getPA().sendFrame34(4819, 4, 1122, 15);
				player.getPA().sendFrame34(-1, 3, 1123, 1);
				player.getPA().sendFrame126(" ", 1135);
				player.getPA().sendFrame126(" ", 1134);
				player.getPA().sendFrame126(" ", 11461);
