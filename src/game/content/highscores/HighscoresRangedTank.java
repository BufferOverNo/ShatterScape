...
public class HighscoresRangedTank
{
		...
		public void sortHighscores(Player player)
		{
				...
				for (int index = 0; index < highscoresList.length; index++)
				{
						...
						if (player.getRangedTankKills() > highscoresList[index].kills && highscoresList[index].name.equalsIgnoreCase(player.getPlayerName()) || player.deathTypes[AchievementStatistics.RANGED_TANK] > highscoresList[index].deaths && highscoresList[index].name.equalsIgnoreCase(player.getPlayerName()))
						{
						...
						else if (!isOnHighscores(player.getPlayerName()))
						{
								...
								{
										highscoresList[0] = new HighscoresRangedTank(player.getPlayerName(), player.getRangedTankKills(), player.deathTypes[AchievementStatistics.RANGED_TANK], QuestTab.getKDR(player.getRangedTankKills(), player.deathTypes[AchievementStatistics.RANGED_TANK]), player.gameMode);
										break;
								}
						}
