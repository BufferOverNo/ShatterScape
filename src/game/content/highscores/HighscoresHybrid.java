...
public class HighscoresHybrid
{
		...
		public void sortHighscores(Player player)
		{
				...
				for (int index = 0; index < highscoresList.length; index++)
				{
						...
						if (player.getHybridKills() > highscoresList[index].kills && highscoresList[index].name.equalsIgnoreCase(player.getPlayerName()) || player.deathTypes[AchievementStatistics.HYBRID] > highscoresList[index].deaths && highscoresList[index].name.equalsIgnoreCase(player.getPlayerName()))
						{
						...
						else if (!isOnHighscores(player.getPlayerName()))
						{
								...
								{
										highscoresList[0] = new HighscoresHybrid(player.getPlayerName(), player.getHybridKills(), player.deathTypes[AchievementStatistics.HYBRID], QuestTab.getKDR(player.getHybridKills(), player.deathTypes[AchievementStatistics.HYBRID]), player.gameMode);
										break;
								}
						}
