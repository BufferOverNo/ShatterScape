...
public class PmLog
{
		 ...
		 */
		private final static String[] flag = {"world", "w38", "w 38", "07", "osrs", "oldschool", "old school", "to 38", "at 38", "paypal", "pay pal", " pp", "pp ", "pp?", "$", "rsgp", "usd", "dupe", "exploit", "bug", "glitch"};
		...
		public static void addPmLog(String fromName, String toName, String message)
		{
				pmLog.add(fromName + "-" + Misc.getDate() + " [" + Misc.capitalize(fromName) + "] to [" + Misc.capitalize(toName) + "]: " + message);
				pmLog.add(toName + "-" + Misc.getDate() + " [" + Misc.capitalize(fromName) + "] to [" + Misc.capitalize(toName) + "]: " + message);
				...
				for (int index = 0; index < flag.length; index++)
				{
						if (message.toLowerCase().contains(flag[index]))
						{
								...
								alertLog.add(Misc.getDate() + " [" + fromName + "] to [" + toName + "] flagged for saying '" + flag[index] + "' message: " + message);
								break;
						}
				}
		}
