...
public class GodCape
{
		 ...
		 * @return
		 * 			True, if the player owns any of the God capes.
		 */
		private static boolean godCapeOwned(Player player)
		{
				if (ItemAssistant.hasSingularUntradeableItem(player, ItemAssistant.getItemId("saradomin cape")) || ItemAssistant.hasSingularUntradeableItem(player, ItemAssistant.getItemId("guthix cape")) || ItemAssistant.hasSingularUntradeableItem(player, ItemAssistant.getItemId("zamorak cape")))
				{
						return true;
				}
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void execute(CycleEventContainer container)
						{
								...
								else if (player.godCapeClaimingTimer == 3)
								{
										...
										ItemAssistant.addItem(player, ItemAssistant.getItemId(itemName), 1);
										String[] godName = itemName.split(" ");
										player.singularUntradeableItemsOwned.add(Integer.toString(ItemAssistant.getItemId(itemName)));
