...
public class SpiritShieldCrafting
{
		...
		private final static int[] SIGILS = {13746, 13748, 13750, 13752};

		private final static int HOLY_ELIXIR = 13754;

		private final static int SPIRIT_SHIELD = 13734;

		private final static int BLESSED_SPIRIT_SHIELD = 13736;
		...
		public static boolean createSpiritShield(Player player, int itemUsed, int itemUsedOn)
		{
				...
				if (createBlessed)
				{
						...
						player.getDH().sendItemChat1("", "You create a Blessed spirit shield.", BLESSED_SPIRIT_SHIELD, 200, 0, -10);
				}
				int sigilUsed = 0;
				...
				ItemAssistant.addItem(player, sigilUsed - 8, 1);
				player.getDH().sendItemChat1("", "You create the " + ItemAssistant.getItemName(sigilUsed - 8) + ".", sigilUsed - 8, 200, 0, -10);
				Skilling.addSkillExperience(player, 1800, ServerConstants.SMITHING);
				return true;
		}
