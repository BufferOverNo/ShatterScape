...
public class SpecialAttackTracker
{
		...
		public static void displayInterface(Player player, boolean toggle)
		{
				...
				if (npc)
				{
						...
						String[][] array = {
								...
								{
										"(" + ProfileSearch.maximumSpecialAttackNpc[15] + "-" + ProfileSearch.maximumSpecialAttackNpc[16] + "-" + ProfileSearch.maximumSpecialAttackNpc[17] + "-" + ProfileSearch.maximumSpecialAttackNpc[18] + ")",
								...
								{ProfileSearch.maximumSpecialAttackNpc[21] + "-" + ProfileSearch.maximumSpecialAttackNpc[22], "Used " + ProfileSearch.weaponAmountUsedNpc[21]},
								{ProfileSearch.maximumSpecialAttackNpc[23] + "", "Used " + ProfileSearch.weaponAmountUsedNpc[23]},
								{ProfileSearch.maximumSpecialAttackNpc[24] + "", "Used " + ProfileSearch.weaponAmountUsedNpc[24]},
				...
				else
				{
						String[][] array = {
								...
								{
										"(" + ProfileSearch.maximumSpecialAttack[15] + "-" + ProfileSearch.maximumSpecialAttack[16] + "-" + ProfileSearch.maximumSpecialAttack[17] + "-" + ProfileSearch.maximumSpecialAttack[18] + ")",
								...
								{ProfileSearch.maximumSpecialAttack[21] + "-" + ProfileSearch.maximumSpecialAttack[22], "Used " + ProfileSearch.weaponAmountUsed[21]},
								{ProfileSearch.maximumSpecialAttack[23] + "", "Used " + ProfileSearch.weaponAmountUsed[23]},
								{ProfileSearch.maximumSpecialAttack[24] + "", "Used " + ProfileSearch.weaponAmountUsed[24]},
		 ...
		 * @param damage
				 * 			The damage dealt.
		 * @param secondHitsplat
				 * 			True, if the damage belongs to a secondary hitsplat like DDS/Halbred/Saradomin sword.
		 */
		public static void saveMaximumDamage(Player player, int damage, String hitSplat, boolean onNpc)
		{
				...
				for (int i = 0; i < player.specialAttackWeaponUsed.length; i++)
				{
						...
						if (player.specialAttackWeaponUsed[i] == 1)
						{
								if (damage > (onNpc ? player.maximumSpecialAttackNpc[i] : player.maximumSpecialAttack[i]) && System.currentTimeMillis() - player.lastSpecialAttackSaved > 100)
								{
										...
										if (announce)
										{
												...
												player.getPA().sendMessage(ServerConstants.PALE_DARK_BLUE_COL + "New personal record of " + damage + " damage with " + itemName + " on a " + (onNpc ? "Npc" : "player") + "!");
										}
								}
						}
						else if (player.specialAttackWeaponUsed[i] == 2)
						{
								...
								if (onNpc)
								{
										if ((damage + player.firstHitSplatDamage) > (player.maximumSpecialAttackNpc[i] + player.maximumSpecialAttackNpc[i + 1]) && (System.currentTimeMillis() - player.lastSpecialAttackSaved <= 100 || player.specialAttackWeaponUsed[21] == 2 && System.currentTimeMillis() - player.lastSpecialAttackSaved <= 1500))
										{
												player.maximumSpecialAttackNpc[i] = damage;
								...
								{
										if ((damage + player.firstHitSplatDamage) > (player.maximumSpecialAttack[i] + player.maximumSpecialAttack[i + 1]) && (System.currentTimeMillis() - player.lastSpecialAttackSaved <= 100 || player.specialAttackWeaponUsed[21] == 2 && System.currentTimeMillis() - player.lastSpecialAttackSaved <= 1500))
										{
												player.maximumSpecialAttack[i] = damage;
								...
								if (hitSplat.equals("SECOND") && broken)
								{
										...
										if (announce)
										{
												...
												player.getPA().sendMessage(ServerConstants.PALE_DARK_BLUE_COL + "New personal record of " + currentDamage + " damage with " + itemName + " on a " + (onNpc ? "Npc" : "player") + "!");
										}
								}
						}
				}
		...
		public static void saveDragonClawsMaximumDamage(Player player, boolean npc)
		{
				...
				if (npc)
				{
						if ((player.storeDragonClawsDamage[0] + player.storeDragonClawsDamage[1] + player.storeDragonClawsDamage[2] + player.storeDragonClawsDamage[3]) > (player.maximumSpecialAttackNpc[15] + player.maximumSpecialAttackNpc[16] + player.maximumSpecialAttackNpc[17] + player.maximumSpecialAttackNpc[18]))
						{
				...
				{
						if ((player.storeDragonClawsDamage[0] + player.storeDragonClawsDamage[1] + player.storeDragonClawsDamage[2] + player.storeDragonClawsDamage[3]) > (player.maximumSpecialAttack[15] + player.maximumSpecialAttack[16] + player.maximumSpecialAttack[17] + player.maximumSpecialAttack[18]))
						{
				...
				if (message && damage >= 50)
				{
						...
						player.getPA().sendMessage(ServerConstants.PALE_DARK_BLUE_COL + "New personal record of " + damage + " damage with Dragon claws on a " + (npc ? "Npc" : "player") + "!");
				}
