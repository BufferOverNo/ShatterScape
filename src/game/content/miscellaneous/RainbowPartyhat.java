...
public class RainbowPartyhat
{
		...
		private final static int[] PARTY_HATS = {1038, 1040, 1042, 1044, 1046, 1048};
		...
		public static boolean partyHatCombine(Player player, int itemUsedId, int itemUsedWithId)
		{
				...
				if (hasItemUsedPartyhat && hasItemUsedWithPartyhat)
				{
						...
						ItemAssistant.addItem(player, 7011, 1);
						player.getDH().sendItemChat1("", "You've combined the partyhats into a rainbow partyhat!", 7011, 200, 15, 0);
						return true;
				}
		...
		public static void dismantleRainbow(Player player)
		{
				...
				ItemAssistant.deleteItemFromInventory(player, 7011, 1);
				for (int index = 0; index < PARTY_HATS.length; index++)
				{
