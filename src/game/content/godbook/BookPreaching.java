	...
	public static boolean sendPreachOptions(Player player, int itemId)
	{
		switch (itemId)
		{
			case 3840:
				...
				player.lastDialogueSelected = 40;
				player.getDH().sendOption4("Wedding Ceremony", "Blessing", "Last Rites", "Preach");
				return true;
			...
			case 3842:
				...
				player.lastDialogueSelected = 41;
				player.getDH().sendOption4("Wedding Ceremony", "Blessing", "Last Rites", "Preach");
				return true;
			case 3844:
				player.nextDialogue = 0;
				player.setDialogueAction(42);
				player.lastDialogueSelected = 42;
				player.getDH().sendOption4("Wedding Ceremony", "Blessing", "Last Rites", "Preach");
				return true;
		}
		return false;
	...
	public static void handlePreach(final Player player, int itemId, final int preachType)
	{
		...
		CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
		{
			...
			public void execute(CycleEventContainer container)
			{
				...
				{
					player.forcedChat(books.preachData[preachType][currentQuote]);
					currentQuote++;
				}
				else
				{
