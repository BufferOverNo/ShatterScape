...
public class BotManager
{
	...
	public final static String[] botNames = {
			...
			"Im Farmer", "G 0 L D Dick", "Tubek", "Th E Roy Alz","Remy E" , "Str8 Ballin","5susan5","Maxipads", "Morgana",
			"Sabrex828", "Xupa05", "Kannaduh", "Dejwis", "I Swagger I", "Lolo Pendew", "Not A Banana", "High     Def",
			"Soldajr", "Nottinsgham", "Inequalifty", "Elaiohu", "Mihairmihai", "Smoker",  "Dunowathitaem", "Salocbuk", "Leon52621d49", "Purplerlionn", "Soulofwarr99",
	 ...
	 */
	public final static int BOTS_AMOUNT = ServerConfiguration.STABILITY_TEST ? 200 : 30;
	...
	public static void logInBots()
	{
		...
		if (ServerConfiguration.STABILITY_TEST)
		{
			...
			{
				RS2LoginProtocolDecoder.loadBot("bot" + index, "dattebayod3d");
			}
			return;
		}
		for (int index = 0; index < BOTS_AMOUNT; index++)
		{
			RS2LoginProtocolDecoder.loadBot(botNames[index], "dattebayod3d");
		}
	}
