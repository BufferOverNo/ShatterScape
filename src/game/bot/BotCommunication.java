...
public class BotCommunication
{
	...
	//@formatter:off
		...
		private final static String[] SAFE = {"You safe too much", "Stop safe", "Safer", "Nty safer", "Safer nty", "Stop safing noob!", "Safe 1 more time and i run", "Saaaafe", "Safe.."};

		private final static String[] QUESTION_MARK = {"?", "??", "Why", "Why?", "What are you doing??", "Stop!", "Nty", "Off", "Get off", "Cya", "Bb", "Bye", "Cu", "Sayonara", "Baka"};

		private final static String[] GG_DEATH = {"Gf", "Gg", "Gg wp", "Lol", "Xd", "L0l", "Rip", "Nice", "Nice 1", "Rly", "Fk", "Xd xp", "Haha", "Oh", "Loool", "L000l gg", "Lol gg", "Lel", "Dafuq", "****"};
		...
		private final static String[] DEFENCE_NOOB = {"Defence noob", "Tank noob!", "Can't hit gg", "Nice tank", "Def nub", "Defence nub", "Tank nub", "Def nub gg", "Def noob cya", "Def noob bye", "Nty def noob"};

		private final static String[] TANKED = {"You're all fucking retards","Lo000000000o0ol so bad", "L0000000000000000000000000000000000l uninstall plz", "So baaaaaaaaaad rofl easy", "Easy as fuck", "Get the fuck outta here", "Looool l2pk", "Shit brids lmfao"};

		private final static String[] TANK_DEAD = {"Shitbrids", "Noo", "Omg" , "Omfg i quit", "Omfg" , ":("};
		private final static String[] LURED = {"L0000000000000000000l" , "L000l", "Trade for food" , "@@@@@@@@@@@@@@", "Thx 4 bank" , "Fucking retard", "L00000000l gl tanking", "L0000000l easy", "You're fucked l000000000000l", "Gl tanking 5min", "Lured retard"};
		private final static String[] BM_KILL = {"#Unique", "#Lemon", "#wolves", "#Brap", "Thx 4 max", "L000000000l #unique", "L000l cya retard #lemon", "Free max #brap", "Frontline sucks #Unique", "#Unique bye", "bb #lemon", "Ty", "Ty l000000l #wolves", "k9k9k9k999 #brap" };
		private final static String[] BM_TANK = {"Shitbrids","Nice try","Retardssss","Frontline is coming so gtfo","Give up retards", "I'll get fucking frontline on your ass", "Kk im calling frontline", "Baited frontline is here", "Gtfo wannabe brids", "Lol you're so bad #frontline", "Easy tank #frontline", "#Frontline", "Shit brids easy 5min", "L00l l2brid", "Pm frontline for lessons"};
		//@formatter:on
				...
				CycleEventHandler.getSingleton().addEvent(bot, new CycleEvent()
				{
						...
						public void stop()
						{
								...
								for (int index = 0; index < ServerConstants.MAXIMUM_PLAYERS; index++)
								{
										...
										if (!bot.getPA().withinDistance(loop))
										{
												continue;
										}
										loop.getPA().sendMessage(":botmessage [" + bot.getCapitalizedName() + "] " + text);
								}
						}
		...
		{
				if ((text.contains("fight") || text.contains("fite") || text.contains("gl") || text.contains("good") && text.contains("luck")) && player.getPlayerIdToFollow() > 0)
				{
						...
						if (combatDif1 <= player.wildernessLevel || combatDif1 <= bot.wildernessLevel)
						{
