		...
		public static void clickNpcType1Event(final Player player)
		{
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void execute(CycleEventContainer container)
						{
								...
								if (!player.getPA().playerOnNpc(player, NpcHandler.npcs[player.getNpcClickIndex()]) && NpcHandler.npcs[player.getNpcClickIndex()] != null && player.playerAssistant.withInDistance(player.getX(), player.getY(), NpcHandler.npcs[player.getNpcClickIndex()].getX(), NpcHandler.npcs[player.getNpcClickIndex()].getY(), 1) && player.getClickNpcType() == 1 && player.getPA().canMoveToNpc(NpcHandler.npcs[player.getNpcClickIndex()]))
								{
		...
		public static void clickNpcType2Event(final Player player)
		{
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void execute(CycleEventContainer container)
						{
								...
								if (!player.getPA().playerOnNpc(player, NpcHandler.npcs[player.getNpcClickIndex()]) && NpcHandler.npcs[player.getNpcClickIndex()] != null && player.playerAssistant.withInDistance(player.getX(), player.getY(), NpcHandler.npcs[player.getNpcClickIndex()].getX(), NpcHandler.npcs[player.getNpcClickIndex()].getY(), 1) && player.getClickNpcType() == 2 && player.getPA().canMoveToNpc(NpcHandler.npcs[player.getNpcClickIndex()]))
								{
										player.turnPlayerTo(NpcHandler.npcs[player.getNpcClickIndex()].getX(), NpcHandler.npcs[player.getNpcClickIndex()].getY());
		...
		public static void clickNpcType3Event(final Player player)
		{
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void execute(CycleEventContainer container)
						{
								...
								if (!player.getPA().playerOnNpc(player, NpcHandler.npcs[player.getNpcClickIndex()]) && NpcHandler.npcs[player.getNpcClickIndex()] != null && player.playerAssistant.withInDistance(player.getX(), player.getY(), NpcHandler.npcs[player.getNpcClickIndex()].getX(), NpcHandler.npcs[player.getNpcClickIndex()].getY(), 1) && player.getClickNpcType() == 3 && player.getPA().canMoveToNpc(NpcHandler.npcs[player.getNpcClickIndex()]))
								{
										player.turnPlayerTo(NpcHandler.npcs[player.getNpcClickIndex()].getX(), NpcHandler.npcs[player.getNpcClickIndex()].getY());
		...
		public static void clickNpcType4Event(final Player player)
		{
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent()
				{
						...
						public void execute(CycleEventContainer container)
						{
								...
								if (!player.getPA().playerOnNpc(player, NpcHandler.npcs[player.getNpcClickIndex()]) && NpcHandler.npcs[player.getNpcClickIndex()] != null && player.playerAssistant.withInDistance(player.getX(), player.getY(), NpcHandler.npcs[player.getNpcClickIndex()].getX(), NpcHandler.npcs[player.getNpcClickIndex()].getY(), 1) && player.getClickNpcType() == 4 && player.getPA().canMoveToNpc(NpcHandler.npcs[player.getNpcClickIndex()]))
								{
										player.turnPlayerTo(NpcHandler.npcs[player.getNpcClickIndex()].getX(), NpcHandler.npcs[player.getNpcClickIndex()].getY());
