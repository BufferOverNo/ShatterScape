...
public class NpcDefinitionCleverJSON extends JSONLoader
{
	...
	{
		super("./data/npc/npc_definition_clever.json");
		load();
	}
	...
	public void load(JsonObject reader, Gson builder)
	{
		...
		NpcDefinition.DEFINITIONS[npcType] = new NpcDefinition(npcType, name, size, roamDistance, deathDeleteTicks, aggressive, meleeAttackAnimation, blockAnimation, deathAnimation, attackSpeed, attackDistance, hitPoints, attack, meleeDefence, rangedDefence, magicDefence, meleeMaximumDamage, rangedMaximumDamage, magicMaximumDamage, respawnTicks, rangedAttackAnimation, magicAttackAnimation, meleeHitsplatDelay, rangedHitsplatDelay, magicHitsplatDelay, true);
	}
}
