...
public class NpcDefinitionCombatJSON extends JSONLoader
{
		...
		{
				super("./data/npc/npc_definition_combat.json");
				load();
		}
		...
		public void load(JsonObject reader, Gson builder)
		{
				...
				int respawnTicks = 70;
				NpcDefinition.DEFINITIONS[npcType] = new NpcDefinition(npcType, name, size, roamDistance, deathDeleteTicks, aggressive, attackAnimation, blockAnimation, deathAnimation, attackSpeed, attackDistance, hitPoints, attack, meleeDefence, rangedDefence, magicDefence, maximumDamage, maximumDamage, maximumDamage, respawnTicks, 0, 0, 0, 0, 0, false);
		}
}
